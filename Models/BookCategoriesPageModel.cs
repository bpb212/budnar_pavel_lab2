...
namespace budnar_pavel_lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(budnar_pavel_lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(budnar_pavel_lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
